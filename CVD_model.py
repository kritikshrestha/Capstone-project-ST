#student test predictor_CapstoneProject
import sklearn
...
gender = le.fit_transform(list(student_data["gender"])) # gender (1 = male; 0 = female)
race =le.fit_transform(list(student_data["race"]))
parentallevelofeducation =le.fit_transform(list(student_data["parentallevelofeducation"]))
lunch =le.fit_transform(list(student_data["lunch"]))
testpreparationcourse =le.fit_transform(list(student_data["testpreparationcourse"]))
mathscore =le.fit_transform(list(student_data["mathscore"]))
readingscore =le.fit_transform(list(student_data["readingscore"]))
writingscore =le.fit_transform(list(student_data["writingscore"]))

x = list(zip(gender, race, parentallevelofeducation, lunch, mathscore, readingscore, writingscore))
y = list(testpreparationcourse)
